...
#importacion de clases para que no se permita el ingreso de numeros solo letras
    ...
    def eliminar(self):
        if aPro.tamañoArregloProducto() == 0:
            ...
            if fila:
                ...
                QtWidgets.QMessageBox.information(self, "Eliminar Producto", "Debe seleccionar un fila...!!!", QtWidgets.QMessageBox.Ok)
