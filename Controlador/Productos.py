class Producto:
    ...
    def __init__(self, codigo, nombre, descripcion, stock_minimo,
    stock_actual, precio_costo, precio_venta, proveedor, almacen):

        self.__codigo = codigo
        self.__nombre = nombre
        self.__descripcion = descripcion
        self.__stockMinimo = stock_minimo
        self.__stockActual = stock_actual
        self.__precioCosto = precio_costo
        self.__precioVenta = precio_venta
